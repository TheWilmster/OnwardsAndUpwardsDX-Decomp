if (instance_exists(obj_player))
{
	...
	if (global.grappled_left == 1 && mode == 3)
	{
		...
		else if (place_meeting(x - 2, y, obj_collide_all_around) && t2 != 0)
		{
			global.grappled_left = 0;
			global.grappled = 0;
			instance_destroy();
...
if (image_xscale > 10)
	show_debug_message("LEFT grapple went too far (Threshold is 10 vs. " + string(image_xscale) + ")");
