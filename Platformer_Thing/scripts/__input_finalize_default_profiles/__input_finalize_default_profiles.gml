function __input_finalize_default_profiles()
{
	...
	if (_global.__touch_allowed && !_global.__any_touch_binding_defined)
		variable_struct_set(_global.__default_profile_dict, "touch", {});
	...
	if (!variable_struct_exists(_global.__profile_dict, "mouse_only"))
		__input_trace("Warning! Default profile for mouse \"", "mouse_only", "\" has not been defined in __input_config_verbs()");
