function input_debug_all_input(arg0 = undefined, arg1 = undefined, arg2 = undefined)
{
	...
	if (arg2 == undefined)
	{
		arg2 = [__input_global().__source_keyboard, __input_global().__source_mouse];
		_i = 0;
	...
	repeat (array_length(arg2))
	{
		...
		with (arg2[_i])
		{
			...
			if (self == __input_global().__source_mouse && true)
			{
				...
				{
					if ((1 || os_type == os_windows) && _filter_func(1, _ignore_struct, _allow_struct) && mouse_check_button(mb_left))
