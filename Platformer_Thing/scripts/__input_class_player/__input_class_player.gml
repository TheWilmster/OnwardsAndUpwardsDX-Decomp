function __input_class_player() constructor
{
		...
		if (arg0 == undefined)
		{
			...
			switch (3)
			{
				case 0:
					...
					break;
				case 1:
					if (__input_global().__on_desktop && _keyboard_profile_allowed)
				...
				case 3:
					...
					break;
				default:
					__input_error("Unhandled INPUT_FALLBACK_PROFILE_BEHAVIOR value (", 3, ")");
					break;
			}
		}
	...
	static __binding_set = function(arg0, arg1, arg2, arg3)
	{
		...
		if ((arg0 == "keyboard_and_mouse" || arg0 == "mouse_only" || arg0 == "touch" || arg0 == "gamepad") && arg0 != "mixed" && arg0 != "multidevice")
		{
			switch (arg3.__get_source_type())
			{
				case (0 << 0):
					if (!(arg0 == "keyboard_and_mouse" || (false && arg0 == "mouse_only")))
					{
					...
					break;
				case (1 << 0):
					if (!(arg0 == "mouse_only" || (false && arg0 == "keyboard_and_mouse")))
					{
						if (__global.__strict_binding_check)
	...
	static __add_complex_verb = function(arg0, arg1)
	{
		...
		else
		{
			...
			_verb_state_struct.type = arg1;
			_verb_state_struct.analogue = false;
			variable_struct_set(__verb_state_dict, arg0, _verb_state_struct);
		}
	};
	
	static __add_combo_state = function(arg0, arg1)
	{
		if (is_struct(variable_struct_get(__combo_state_dict, arg0)))
			__input_error("Combo state with name \"", arg0, "\" has already been added to player ", __index);
		else
			variable_struct_set(__combo_state_dict, arg0, new __input_class_combo_state(arg0, arg1));
	};
	...
	static tick_basic_verbs = function()
	{
		...
		repeat (array_length(__global.__basic_verb_array))
		{
			variable_struct_get(__verb_state_dict, __global.__basic_verb_array[_v]).tick(__verb_group_state_dict, __active);
			_v++;
		}
	};
	...
	static tick_chord_verbs = function()
	{
		...
		repeat (array_length(__global.__chord_verb_array))
		{
			...
			{
				variable_struct_get(__verb_state_dict, _chord_name).tick(__verb_group_state_dict, __active);
			}
			_i++;
		}
	};
	...
	static tick_combo_verbs = function()
	{
		...
		repeat (array_length(__global.__combo_verb_array))
		{
			...
			{
				variable_struct_get(__verb_state_dict, _combo_name).tick(__verb_group_state_dict, __active);
			}
			_i++;
		}
	};
