function input_xy(arg0, arg1, arg2, arg3, arg4 = 0, arg5 = false)
{
	...
	var _value_l = _verb_struct_l.__inactive ? 0 : _verb_struct_l.raw;
	var _value_r = _verb_struct_r.__inactive ? 0 : _verb_struct_r.raw;
	var _value_u = _verb_struct_u.__inactive ? 0 : _verb_struct_u.raw;
	var _value_d = _verb_struct_d.__inactive ? 0 : _verb_struct_d.raw;
	...
	if (arg5)
	{
		if (_value_l > 0 && _value_r > 0)
			_dx = (_verb_struct_l.press_time > _verb_struct_r.press_time) ? -_value_l : _value_r;
		if (_value_u > 0 && _value_d > 0)
			_dy = (_verb_struct_u.press_time > _verb_struct_d.press_time) ? -_value_u : _value_d;
	}
