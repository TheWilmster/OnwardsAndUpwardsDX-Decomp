function input_mouse_capture_set(arg0, arg1 = 1)
{
	...
	switch (os_type)
	{
		case os_windows:
			...
			{
				if (_monitor_coords[(_i * 8) + 2] != 0 && _monitor_coords[(_i * 8) + 3] != 0 && ((_monitor_coords[(_i * 8) + 2] - _monitor_coords[_i * 8]) != _window_width || (_monitor_coords[(_i * 8) + 3] - _monitor_coords[(_i * 8) + 1]) != _window_height))
				{
