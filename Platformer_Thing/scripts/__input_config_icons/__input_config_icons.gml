...
.add("gamepad face south", "#")
.add("gamepad face east", "$")
.add("gamepad face west", "<")
.add("gamepad face north", "=")
.add("gamepad shoulder l", ">")
.add("gamepad shoulder r", "@")
.add("gamepad trigger l", "^")
.add("gamepad trigger r", "_")
.add("gamepad select", "}")
.add("gamepad start", "{")
